...
async function testGetSignedUrl() {
  try {
    ...
    console.log('  - Upload URL:', response.data.uploadUrl.substring(0, 100) + '...');
...
async function testS3Integration() {
  console.log('🚀 Starting S3 Upload Integration Test\n');
  console.log('========================================');
  
  try {
    // Step 1: Register or login
    const authResult = await register() || await login();
