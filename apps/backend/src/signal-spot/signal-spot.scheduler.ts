...
export class SignalSpotScheduler {
  ...
  // TEMPORARILY DISABLED: Run every 5 minutes to expire spots
  // @Cron('*/5 * * * *', {
  ...
  // TEMPORARILY DISABLED: Run every hour to clean up old expired spots
  ...
  // TEMPORARILY DISABLED: Run weekly to clean up very old data
